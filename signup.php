...
<body>
    <?php if (isset($_GET['error']) && $_GET['error'] === 'hr_email_domain'): ?>
        <script>
            alert("Sign up failed. HR accounts require a company email address (personal email domains are not allowed).");
        </script>
    <?php endif; ?>
